package algorithmtype.symmetric.aes.mode.ofb.padding.ansix923;
...
public class CustomSymmetricAesOfbANSIX923AlgorithmHandler {
    ...
    public CustomSymmetricAesOfbANSIX923AlgorithmHandler(MontoyaApi api) {
        this.api = api;
        this.logging = api.logging();
    }

    public byte[] SymmetricAesOfbANSIX923AlgorithmHandler(Boolean isDecrypt, byte[] selectedBytes, ArrayList<String> paramHexValueList) {
        byte[] handlerBytes;
        if (isDecrypt) {
