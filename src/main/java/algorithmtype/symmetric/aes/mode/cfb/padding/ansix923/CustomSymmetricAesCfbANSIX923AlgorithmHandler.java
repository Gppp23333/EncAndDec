package algorithmtype.symmetric.aes.mode.cfb.padding.ansix923;
...
public class CustomSymmetricAesCfbANSIX923AlgorithmHandler {
    ...
    public CustomSymmetricAesCfbANSIX923AlgorithmHandler(MontoyaApi api) {
        this.api = api;
        this.logging = api.logging();
    }

    public byte[] SymmetricAesCfbANSIX923AlgorithmHandler(Boolean isDecrypt, byte[] selectedBytes, ArrayList<String> paramHexValueList) {
        byte[] handlerBytes;
        if (isDecrypt) {
