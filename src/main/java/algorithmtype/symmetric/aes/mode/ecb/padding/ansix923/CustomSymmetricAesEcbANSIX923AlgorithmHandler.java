package algorithmtype.symmetric.aes.mode.ecb.padding.ansix923;
...
public class CustomSymmetricAesEcbANSIX923AlgorithmHandler {
    ...
    public CustomSymmetricAesEcbANSIX923AlgorithmHandler(MontoyaApi api) {
        this.api = api;
        this.logging = api.logging();
    }

    public byte[] SymmetricAesEcbANSIX923AlgorithmHandler(Boolean isDecrypt, byte[] selectedBytes, ArrayList<String> paramHexValueList) {
        byte[] handlerBytes;
        if (isDecrypt) {
