package algorithmtype.symmetric.aes.mode.ctr.padding.ansix923;
...
public class CustomSymmetricAesCtrANSIX923AlgorithmHandler {
    ...
    public CustomSymmetricAesCtrANSIX923AlgorithmHandler(MontoyaApi api) {
        this.api = api;
        this.logging = api.logging();
    }

    public byte[] SymmetricAesCtrANSIX923AlgorithmHandler(Boolean isDecrypt, byte[] selectedBytes, ArrayList<String> paramHexValueList) {
        byte[] handlerBytes;
        if (isDecrypt) {
